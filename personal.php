...
<body>
 ...
 -->
	...
	<div class="images1">
        ...
        $query = $db_handle->runQuery("SELECT * FROM missing where username='$username' ORDER BY id ASC");
        if (! empty($query)) {
            foreach ($query as $key => $value) {
                ...
                <div class="name">
                   ...
                   <!--  <div class="name">
                    ...
                    <div class="name">
                        <?php
                        echo("<b class='found'>".$query[$key]['found']."</b>");
                        ?>
	...
	<form action="upload.php" method="POST" enctype="multipart/form-data">
		...
		<input type="text" name="name" placeholder="provide name of missing person"><br><br>
